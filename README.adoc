...
image:https://travis-ci.org/phgrosjean/aurelhy.svg?branch=master["Build Status", link="https://travis-ci.org/phgrosjean/aurelhy"]
OSXimage:https://travis-ci.org/phgrosjean/aurelhy.svg?branch=macosx["Build Status", link="https://travis-ci.org/phgrosjean/aurelhy"]
image:https://codecov.io/github/phgrosjean/aurelhy/coverage.svg?branch=master["Coverage Status", link="https://codecov.io/github/phgrosjean/aurelhy?branch=master"]
